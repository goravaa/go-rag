...
func (_u *UserUpdate) AddQueries(v ...*UserPrompt) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) RemoveQueries(v ...*UserPrompt) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// SetEmailConfirmed sets the "email_confirmed" field.
func (_u *UserUpdateOne) SetEmailConfirmed(v bool) *UserUpdateOne {
	_u.mutation.SetEmailConfirmed(v)
	return _u
}

// SetNillableEmailConfirmed sets the "email_confirmed" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableEmailConfirmed(v *bool) *UserUpdateOne {
	if v != nil {
		_u.SetEmailConfirmed(*v)
	}
	return _u
...
// AddQueries adds the "queries" edges to the UserPrompt entity.
func (_u *UserUpdateOne) AddQueries(v ...*UserPrompt) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveQueries removes "queries" edges to UserPrompt entities.
func (_u *UserUpdateOne) RemoveQueries(v ...*UserPrompt) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
