...
// The QueryResultFunc type is an adapter to allow the use of ordinary
// function as QueryResult mutator.
type QueryResultFunc func(context.Context, *ent.QueryResultMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f QueryResultFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.QueryResultMutation); ok {
		return f(ctx, mv)
	}
...
// The UserPromptFunc type is an adapter to allow the use of ordinary
// function as UserPrompt mutator.
type UserPromptFunc func(context.Context, *ent.UserPromptMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserPromptFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserPromptMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserPromptMutation", m)
}
